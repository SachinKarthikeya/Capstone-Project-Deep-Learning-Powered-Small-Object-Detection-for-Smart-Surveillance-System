...
dataset = WeaponSSDDataset(
    csv_path="/Users/sachinkarthikeya/Downloads/Capstone Project/ssd-guns-detection-csv/CGI-Weapon-Dataset-2/valid/_annotations.csv",
...
# SAVE MODEL
# =========================
torch.save(model.state_dict(), "mobilenet_ssd_model_2.pth")
print("Training complete..........")
print("Model saved as mobilenet_ssd_model_2.pth")